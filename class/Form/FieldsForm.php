...
class FieldsForm extends \Xoops\Form\ThemeForm
{
    ...
    public function __construct(Tdmcreate\Fields &$obj, $field_mid = 0, $field_tid = 0, $field_numb = 0, $field_name = '')
    {
        ...
        $title = $obj->isNew() ? sprintf(Tdmcreate\Locale::ADD_FIELDS) : sprintf(Tdmcreate\Locale::EDIT_FIELDS);
        ...
        if ($numb_fields > 0) {
            ...
            $main_tray->addElement(new Xoops\Form\Raw('<th>' . Tdmcreate\Locale::L_NAME . '</th>'));
            $main_tray->addElement(new Xoops\Form\Raw('<th>' . Tdmcreate\Locale::L_TYPE . '</th>'));
            $main_tray->addElement(new Xoops\Form\Raw('<th>' . Tdmcreate\Locale::L_VALUE . '</th>'));
            $main_tray->addElement(new Xoops\Form\Raw('<th>' . Tdmcreate\Locale::L_ATTRIBUTES . '</th>'));
            $main_tray->addElement(new Xoops\Form\Raw('<th>' . Tdmcreate\Locale::L_NOTNULL . '</th>'));
            $main_tray->addElement(new Xoops\Form\Raw('<th>' . Tdmcreate\Locale::L_DEFAULT . '</th>'));
            $main_tray->addElement(new Xoops\Form\Raw('<th>' . Tdmcreate\Locale::L_KEY . '</th>'));
            $main_tray->addElement(new Xoops\Form\Raw('<th>' . Tdmcreate\Locale::L_ARGUMENTS . '</th></tr>'));
            ...
            for ($i = 0; $i < $numb_fields; ++$i) {
                ...
                $field_name = new Xoops\Form\Text(Tdmcreate\Locale::FIELD_NAME, 'field_name', 1, 25, $field_name);
                $main_tray->addElement(new Xoops\Form\Raw('<td>' . $field_name->render() . '</td>'));
                $field_type_select = new Xoops\Form\Select(Tdmcreate\Locale::FIELD_TYPE, 'field_type', $obj->getVar('field_type'));
                ...
                $field_value = new Xoops\Form\Text(Tdmcreate\Locale::FIELD_VALUE, 'field_value', 1, 10, $field_value);
                $main_tray->addElement(new Xoops\Form\Raw('<td>' . $field_value->render() . '</td>'));
                $field_attrs_select = new Xoops\Form\Select(Tdmcreate\Locale::FIELD_ATTRIBUTE, 'field_attribute', $obj->getVar('field_attribute'));
                ...
                $field_null_select = new Xoops\Form\Select(Tdmcreate\Locale::FIELD_NULL, 'field_null', $obj->getVar('field_null'));
                ...
                $field_default = new Xoops\Form\Text(Tdmcreate\Locale::FIELD_DEFAULT, 'field_default', 1, 25, $obj->getVar('field_default'));
                $main_tray->addElement(new Xoops\Form\Raw('<td>' . $field_default->render() . '</td>'));
                $field_key_select = new Xoops\Form\Select(Tdmcreate\Locale::FIELD_KEY, 'field_key', $obj->getVar('field_key'));
                ...
                if (0 == $i) {
                    ...
                    $check_field_autoincrement->addOption(1, Tdmcreate\Locale::FIELD_AUTO_INCREMENT);
                    ...
                    $field_elements_select = new Xoops\Form\Select(Tdmcreate\Locale::FIELD_ELEMENTS, 'field_elements', $obj->getVar('field_elements'));
                    ...
                    //$mini_tray->addElement(new Xoops\Form\Raw('<table><thead><th>'.Tdmcreate\Locale::L_EXTRA.'</th></thead>'));
                    ...
                    $check_field_admin->addOption(1, Tdmcreate\Locale::C_FIELD_ADMIN);
                    ...
                    $check_field_user->addOption(1, Tdmcreate\Locale::C_FIELD_USER);
                    ...
                    $check_field_block->addOption(1, Tdmcreate\Locale::C_FIELD_BLOCK);
                    ...
                    $field_main_radio->addOption('&nbsp;', Tdmcreate\Locale::C_FIELD_MAINFIELD);
                    ...
                    $check_field_search->addOption(1, Tdmcreate\Locale::C_FIELD_SEARCH);
                    ...
                    $check_field_required->addOption(1, Tdmcreate\Locale::C_FIELD_REQUIRED);
